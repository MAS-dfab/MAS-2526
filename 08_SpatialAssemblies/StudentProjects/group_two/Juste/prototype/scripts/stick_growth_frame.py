...
class GrowTowards:
    ...
    def get_root_child_stick(self, frame, intersection):
        ...
        #initialise new stick
        new_stick = Stick(root_child_frame, length = self.stick_length)
    ...
    def get_target_child_stick(self, frame, intersection): #intersection is a compas Line
        ...
        """
        #create stick properties for axis
        ...
        new_stick = Stick(r_target_child_frame, length = self.stick_length)
